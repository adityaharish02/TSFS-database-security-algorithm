...
public class Decryption extends KeyInputs
{
    ...
    public String performDecryptionOperation(String text)
    {
        ...
        for(int i=0 ; i<count; i++)
        {
           ...
           newTextMatrix = convertToMatrix(newText);
            ...
            for(int j=0;j<4;j++)
                for(int k=0;k<4;k++)
                    decryptedText = decryptedText+""+newTextMatrix[j][k];
        }
    ...
    String[][] transposition(String newTextMatrix[][])
    {
        ...
        transposeMatrix[1][0] = newTextMatrix[0][2]; transposeMatrix[2][0] = newTextMatrix[0][3];
        transposeMatrix[1][1] = newTextMatrix[1][0]; transposeMatrix[0][2] = newTextMatrix[1][1];
        transposeMatrix[0][3] = newTextMatrix[1][2]; transposeMatrix[1][2] = newTextMatrix[1][3];
        transposeMatrix[2][1] = newTextMatrix[2][0]; transposeMatrix[3][0] = newTextMatrix[2][1];
        transposeMatrix[3][1] = newTextMatrix[2][2]; transposeMatrix[2][2] = newTextMatrix[2][3];
        transposeMatrix[1][3] = newTextMatrix[3][0]; transposeMatrix[2][3] = newTextMatrix[3][1];
    ...
    String[][] folding(String[][] newTextMatrix)
    {
        ...
        for(int i=0;i<4;i++)
        {
            String temp = newTextMatrix[i][2];
            newTextMatrix[i][2] = newTextMatrix[i][0];
            newTextMatrix[i][0] = temp;
        }
        for(int i=0;i<4;i++)
        {
    ...
    String [][] shifting(String newTextMatrix[][])
    {
        ...
        for(int i=0;i<4;i++)
        {
            for(int j=0;j<4;j++)
            {
                int val = referenceShifting.indexOf(newTextMatrix[i][j].charAt(0));
                newTextMatrix[i][j] = String.valueOf(referenceVal.charAt(val));
            }
        }
        return newTextMatrix;
    }
